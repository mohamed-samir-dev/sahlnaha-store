...
export default async function Home() {
  ...
  return (
    <>
      ...
      />
      <main className="min-h-screen bg-[#d4f3eb]" style={{ backgroundImage: "linear-gradient(rgba(4,69,74,0.16) 1px, transparent 1px), linear-gradient(90deg, rgba(4,69,74,0.16) 1px, transparent 1px)", backgroundSize: "40px 40px" }}>
        <HeroSection />
        <StaticCategories />
