...
/* ── Data ── */
const stats = [
  { value: "١٠٠٪", label: "ضمان الجودة",  Icon: IconShield,  gradient: "from-blue-500 to-blue-600",    ring: "ring-blue-100",   text: "text-blue-600"   },
  { value: "٢٤/٧",  label: "دعم فني",      Icon: IconHeadset, gradient: "from-violet-500 to-violet-600", ring: "ring-violet-100", text: "text-violet-600" },
  { value: "٠٪",    label: "بدون فوائد",   Icon: IconPercent, gradient: "from-emerald-500 to-teal-500",  ring: "ring-emerald-100",text: "text-emerald-600"},
  { value: "سريع",  label: "توصيل",        Icon: IconTruck,   gradient: "from-orange-400 to-rose-500",   ring: "ring-orange-100", text: "text-orange-500" },
];
...
const sections = [
  {
    ...
    content: [
      "مؤسسة بصمة هاتفي المعتمد   هو متجر إلكتروني متخصص في تقديم المنتجات والخدمات بجودة عالية وتجربة شراء سهلة وآمنة تناسب احتياجات العملاء.",
      ...
      " مؤسسة بصمة هاتفي المعتمد  هو اختيارك الأول لشراء أحدث الأجهزة الإلكترونية بأقساط سهلة وبدون فوائد، وتلقى عندنا تجربة مختلفة تبدأ من جودة الخدمة وسرعة التوصيل إلى اهتمام كبير بخدمة ما بعد البيع — نتابعك خطوة بخطوة ونوفّر لك دعم فني وضمان يخليك واثق إنك تتعامل مع متجر يحط رضاك فوق كل اعتبار.",
    ],
  },
  {
    Icon: IconTarget,
